...
-- Ensure RLS is enabled on tasks table (may have been created externally)
alter table public.tasks enable row level security;

-- Tasks table policies (safe re-run)
do $$ begin
...
-- Also add RLS policies for profiles table used by profile page
