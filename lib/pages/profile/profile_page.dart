...
class _ProfilePageState extends ConsumerState<ProfilePage>
        ...
        child: ListView(
          ...
          children: [
            ...
            GridView.count(
              ...
              children: [
                _StatBox(
                    value: '${tState.doneCount}',
                    label: 'Tasks Done'),
                _StatBox(value: '30', label: 'Day Streak'),
                _StatBox(value: rank.name, label: 'Rank'),
                _StatBox(
                    value: '${SeedData.badges.where((b) => b['unlocked'] == true).length}',
                    label: 'Badges'),
              ],
            ),
            const SizedBox(height: 10),
            ...
            Container(
              ...
              child: TabBar(
                ...
                labelStyle:
                    AppTheme.sans(size: 10, weight: FontWeight.w700),
  ...
  void _confirmClear(BuildContext context, WidgetRef ref) {
    final taskCount = ref.read(taskProvider).totalCount;
    showDialog(
      context: context,
      builder: (_) => Dialog(
        backgroundColor: AppColors.surface2,
