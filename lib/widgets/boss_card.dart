    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(boss.name, style: AppTheme.mono(size: 12, weight: FontWeight.w800)),
          if (boss.isDefeated)
            Padding(
              padding: const EdgeInsets.only(top: 4),
              child: Text('🎉 DEFEATED!',
                  style: AppTheme.sans(size: 12, weight: FontWeight.w800, color: AppColors.accent)),
            ),
          const SizedBox(height: 10),
          // HP row
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('HP', style: AppTheme.mono(size: 9, color: AppColors.subtle)),
